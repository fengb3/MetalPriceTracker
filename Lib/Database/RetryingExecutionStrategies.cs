...
public class RetryingExecutionStrategies(ExecutionStrategyDependencies dependencies) : NpgsqlRetryingExecutionStrategy(dependencies)
{
    protected override bool ShouldRetryOn(Exception? exception)
    {
        if (exception is PostgresException postgresException)
        {
            // PostgresSQL-specific error code
